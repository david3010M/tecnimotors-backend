 ...
 *     @OA\Property(property="paymentDate", type="string", example="2024-06-27 22:59:36"),
 *     @OA\Property(property="routeVoucher", type="string", example="image"),
 *     @OA\Property(property="numberVoucher", type="string", example="123456"),
 *     @OA\Property(property="yape", type="number", example="100.00"),
 *     @OA\Property(property="deposit", type="number", example="100.00"),
 *     @OA\Property(property="cash", type="number", example="100.00"),
 *     @OA\Property(property="plin", type="number", example="100.00"),
 *     @OA\Property(property="card", type="number", example="100.00"),
