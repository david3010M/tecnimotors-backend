    ...
    try {
        ...
        return DB::transaction(function () use ($map, $attention, $budget, $concept_id) {
            ...
            foreach ($map as $productId => $qty) {
                ...
                // Nota: se permite que el stock quede negativo intencionalmente — NO se verifica disponibilidad.
                ...
                // Decrementar stock aunque resulte en valor negativo (asegúrate que columna sea SIGNED)
            ...
            return DB::transaction(function () use ($incoming, $object, $budget) {
                ...
                foreach ($allIds as $pid) {
                    ...
                    if ($newQty > $oldQty) {
                        ...
                        // Nota: validación de stock eliminada intencionalmente — se permite stock negativo.
