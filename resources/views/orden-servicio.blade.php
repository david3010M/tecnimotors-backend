    ...
    <div class="content">
        <table style="margin-bottom: 8px;">
            <tr>
                <th>Cliente</th>
                <td colspan="3">
                    {{ $order->vehicle->person->typeofDocument == 'DNI' ? $order->vehicle->person->names . ' ' . $order->vehicle->person->fatherSurname . ' ' . $order->vehicle->person->motherSurname : $order->vehicle->person->businessName }}
                </td>
                <th>DNI</th>
                <td>{{ $order->vehicle->person->typeofDocument == 'DNI' ? $order->vehicle->person->documentNumber : '' }}
                </td>
            </tr>
            <tr>
                <th>Dirección</th>
            ...
            <tr>
                <th>RUC</th>
                <td>{{ $order->vehicle->person->typeofDocument == 'RUC' ? $order->vehicle->person->documentNumber : '' }}
                </td>
                <th>Email</th>
        ...
        <div>
            <table>
                ...
                <tr>
                    ...
                    <td colspan="3">{{ fuelLevelToFraction($order->fuelLevel) }} Tanque</td>
